...
async function loadMembers() {
  ...
  try {
    const data: any = await appApi.getFamilyMembers();
...
async function loadRecipes() {
  ...
  try {
    ...
    const data: any = await appApi.getFamilyRecipes(params);
...
function goRecipeDetail(r: any) {
  router.push('/family/recipe/' + r.id);
}

// 跳转新建菜谱
function goCreateRecipe() {
  router.push('/family/recipe/form');
}
...
async function handleInvite() {
  ...
  try {
    const data: any = await appApi.createInvitation();
...
async function toggleVisibility(recipe: any) {
  ...
  try {
    await appApi.updateRecipeVisibility(recipe.id, next);
...
async function loadWeeklyMenu() {
  ...
  try {
    const data: any = await appApi.getWeeklyMenu();
...
async function voteMenu(item: any, vote: 'like' | 'dislike') {
  try {
    await appApi.voteMenuItem(item.id, vote);
...
async function loadShoppingList() {
  ...
  try {
    const data: any = await appApi.getShoppingList();
...
async function submitShoppingAdd() {
  ...
  try {
    ...
    await appApi.addShoppingItem(data);
...
async function toggleShopping(item: any) {
  ...
  try {
    await appApi.toggleShoppingItem(item.id, item.checked);
  } catch (err: any) {
    item.checked = prev;
...
async function removeShopping(item: any) {
  try {
    await appApi.deleteShoppingItem(item.id);
...
async function generateShopping() {
  ...
  try {
    const data: any = await appApi.generateShoppingFromMenu();
...
async function loadRecords() {
  ...
  try {
    const data: any = await appApi.getFamilyRecords();
...
async function toggleLike(r: any) {
  ...
  try {
    await appApi.toggleRecordLike(r.id);
    r.liked = !prevLiked;
...
async function submitComment(r: any) {
  ...
  try {
    await appApi.addRecordComment(r.id, commentText.value.trim());
